...
# I hate you so much text editor, why does this of all art pieces stretch out?????????????
def Mansion_Art():
...
# day is never finished master got me working someday master set me free day is never finished master got me working someday master set me free 
# also this is the final art for journey 2
def Swamp_Art():
  print(Fore.GREEN + """
...
def BloodDrinker_Akazuris_Turn():
  ...
  BloodDrinker_Akazuris_Random_Choices = random.randint(0, 2)

  BloodDrinker_Akazuri_Weapons = [Hand_Of_Blood, Sacrifical_Lamb, Tres_duos_unus]
  BloodDrinker_Akazuris_Description = ["shedded the players skin causing blood loss", "sacrificed a lamb making the player distressed", "casted a bloodloss spell making the player lightheaded"]


  Weapon_Selection = BloodDrinker_Akazuri_Weapons[BloodDrinker_Akazuris_Random_Choices]
  Description_Selection = BloodDrinker_Akazuris_Description[BloodDrinker_Akazuris_Random_Choices]
...
def BloodDrinker_Akazuri_Fight(HP_player, BloodDrinker_Akazuri_HP, End_Combat, Weapon_List, Death_Hunt_Sickle, Glinted_Zweihander, Lightning_Strike, Block, Block_Percentage_Rounded):

  while BloodDrinker_Akazuri_HP > Death or HP_player > Death and End_Combat == False:
    
    # import the variables returned from previous functions to this current function 
    HP_player,  Numerical_Order, Dodge_Attack, Death_Hunt_Sickle, Glinted_Zweihander, Lightning_Strike, Block, Block_Percentage_Rounded = Players_turn(HP_player)
    Weapon_Selection, Description_Selection = BloodDrinker_Akazuris_Turn() 
    
    print(f"\n\n------------------------------------------------")
    print(f"         BloodDrinker Akazuri HP: {BloodDrinker_Akazuri_HP}")
    print(f"------------------------------------------------")
    ...
    if Weapon_Choice == 1 and Dodge_Attack != 1:
      ...
      BloodDrinker_Akazuri_HP -= Death_Hunt_Sickle
      print(f"\n{Player_Name} has swinged their Death Hunt Sickle and dealt {Death_Hunt_Sickle} damage! ")
      
      HP_player -= Weapon_Selection
      print(f"\nBloodDrinker Akazuri has {Description_Selection} and dealt {Weapon_Selection} damage!")
      ...
      print(f"\nBloodDrinker Akazuri has {Description_Selection} however, it missed! ")
      ...
      BloodDrinker_Akazuri_HP -= Glinted_Zweihander
      print(f"\n{Player_Name} casted the Glinted Zweihander sorcery and dealt {Glinted_Zweihander} damage! ")
      ...
      BloodDrinker_Akazuri_HP -= Lightning_Strike
      print(f"\n{Player_Name} struck their lightning bolt incanation and dealt {Lightning_Strike} damage! ")
      ...
      print(f"\n{Player_Name} used Block and has negated {Block_Percentage_Rounded}% of BloodDrinker Akazuri's damage! (damage now dealt: {New_Damage_Rounded}).")
    ...
    if BloodDrinker_Akazuri_HP <= Death: 
      End_Combat = True
      HP_player += Heal_player

      time.sleep(3)
      print(f"\nBloodDrinker Akazuri (HP: {BloodDrinker_Akazuri_HP}) what are you trying to prove? how many have you killed to get here? did you even listen to them? I may fade but I sincerely wish you torturous death served on a silver platter. ")
      time.sleep(5)
      print(f"\nThe fight concludes with {Player_Name} defeating BloodDrinker Akazuri (HP awarded: {Heal_player} new HP: {HP_player}).")
      time.sleep(4)
...
while Input_Validation == False: 
  ...
  if Path_chosen.lower() == "neighbourhood":
    ...
    BloodDrinker_Akazuri_Art()
    
    time.sleep(5)  
    print(f"\nBloodDrinker Akazuri (HP: {BloodDrinker_Akazuri_HP}): you called for death and death answered {Player_Name}, you killed my servant interrupting my plan its only fair to steal your existance.")
    time.sleep(5)
    print(f"\nBloodDrinker Akazuri (HP: {BloodDrinker_Akazuri_HP}): ever heard of the saying 'an eye for an eye a tooth for a tooth'? nevermind that your an atheist equally as ignorant as your kind a mere fool if you will now perish at once.")

    HP_player = BloodDrinker_Akazuri_Fight(HP_player, BloodDrinker_Akazuri_HP, End_Combat, Weapon_List, Death_Hunt_Sickle, Glinted_Zweihander, Lightning_Strike, Block, Block_Percentage_Rounded)
    ...
    time.sleep(3.5)
    print("\nA summoning stone has appeared as a result of akazuri's death the player gripped the stone getting ready to skim it across the lake nearby for fun to only be teleported to a foggy world.")
    time.sleep(5.5)
